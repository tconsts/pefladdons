...
var field_player_img_src		= (isNaN(parseInt(localStorage.myintid)) ? '/field/img/146cd60f8c4985270b74f7839e98059a.png' : 'system/img/forms/n'+(parseInt(localStorage.myintid)>1000 ? parseInt(localStorage.myintid)-1000 : localStorage.myintid)+'a.png')
var goalkeeper_player_img_src	= (isNaN(parseInt(localStorage.myintid)) ? '/field/img/41ccf2617ef2be4688e36fefa1eefcb7.png' : 'system/img/forms/n'+(parseInt(localStorage.myintid)>1000 ? parseInt(localStorage.myintid)-1000 : localStorage.myintid)+'c.png')
...
$().ready(function() {
	...
	delete localStorage.fp_uniform_n
	delete localStorage.gk_uniform_n
	...
	$.get('fieldnew3_n.php', {}, function(data){
		...
		preparedhtml += '<img width=41 src="'+ field_player_img_src +'" alt="" id="fp_uniform_image" />'
		preparedhtml += '</td><td>'
		preparedhtml += 'Полевого<br />';
		preparedhtml += '<a href="javascript: change_field_player_uniform();">Поменять</a><br />';
		preparedhtml += '</td></tr>'
		preparedhtml += '<tr><td>';
		preparedhtml += '<img width=41 src="'+ goalkeeper_player_img_src +'" alt="" id="gk_uniform_image" />';
		preparedhtml += '</td><td>'
