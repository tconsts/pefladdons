...
$().ready(function() {
	...
	var poss = [['','','',''],
		...
		['Стд. атаки','skillsstda','','',16,'!сст,!s=*100,вп=*3,гл=*3,мщ=*2,ск=*1,са,f=*0,Фам,ск=*0,от=*-1'],
		['Стд. обороны','skillsstdd','','',16,'!сст,!s=*100,вп=*3,гл=*3,мщ=*2,ск=*1,со,f=*0,Фам,ск=*0,др=*-1,уд=*-1'],
		['Исп. угловых','skillscor','','',16,'!сст,!s=*100,уг=*1.5,нв=*1,ви=*1,f=*0,Фам,иу=*0'],
