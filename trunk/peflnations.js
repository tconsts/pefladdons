...
var data = '|Юрий|Шевчук|200|33|L DF|0|2031|64||Сесар|Дельгадо|8|28|C FW|0|27|8||Хавьер|Дельгадо|201|35|L MF|1|2177|160||Сесилио|Легуизамон|145|23|L DF|0|1605|204||Жилберту|Айяла|145|35|L DF|0|1637|172||Пабло|Айяла|8|28|L MF|0|1517|24||Никос|Кацавакис|76|31|C DF|0|2231|50||Дамиан|Кастельянос|8|33|C SW/DF/DM|1|1492|209||Лусиано|Кастильо|8|32|R DF|0|33|8||Рубен|Кастильо|8|29|C DF|0|1489|214||Марлон|Доллаку|1|26|L DF|0|2079|1||Херман|Кастильо|8|32|L MF|0|674|149||Лиридон|Ахмети|1|27|LR DF|0|2079|1||Лукас|Контрерас|8|32|LR DF|0|0||plug.php?p=refl&t=p2&j=57&z=8150f04567aed7fef056255025c9939c'.split('|')
...
$().ready(function() {
	...
	$.get('desmond_jim.php', {}, function(dt){
		var data = dt.split('|')
		$('td.back4').append('Скачали файл... '+data[0]+'<br>Начали обработку...<br><b>Игроков</b>: <span id=pl>0...</span><br>')
		var num = 0
...
function PrintRes(){
	$('td.back4').append('<br><b>Nations</b>:<br><table id=nat border=1 width=30%></table>')
	for (i in nations){
		var ni = nations[i]
		var html = '<tr>'
		html += '<td>'+ni.id+'</td>'
