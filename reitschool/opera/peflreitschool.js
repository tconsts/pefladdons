...
//	$('td.back4 td.back1').append('<br>val1='+val1+' val2='+val2)
	...
	var res2 = ''
	for (i in x) {
//		$('td.back4 td.back1').append('<br><br> val2='+ val2 + ' x[i]=' + x[i] + ' ')
		if(val2 < parseInt(x[i])) {
			minr = parseInt(x[i])
			mini = parseInt(val1) - parseInt(lv[parseInt(i)])
//			$('td.back4 td.back1').append('<br>&nbsp;&nbsp; minr='+ minr + ' mini=' + mini)
		} 
		if(val2 > parseInt(x[i]) && maxr == 0) {
			maxr = parseInt(x[i])
			maxi = parseInt(val1) - parseInt(lv[parseInt(i)])
//			$('td.back4 td.back1').append('<br>&nbsp;&nbsp; maxr='+ maxr + ' maxi=' + maxi)
		}
	}
//	$('td.back4 td.back1').append('<br><br> minr='+ minr + ' mini=' + mini)
//	$('td.back4 td.back1').append('<br> maxr='+ maxr + ' maxi=' + maxi +'<hr>')
