...
$().ready(function() {
	...
	var poss = [['','','',''],
		...
		['Стд. атаки','skillsstda','','',18,'!сст,!s=*100,вп=*3,гл=*3,мщ=*2,ск=*1,са,f=*0,Фам,ск=*0,от=*-1'],
		['Стд. обороны','skillsstdd','','',18,'!сст,!s=*100,вп=*3,гл=*3,мщ=*2,ск=*1,со,f=*0,Фам,ск=*0,др=*-1,уд=*-1'],
