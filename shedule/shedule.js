$().ready(function() {
	...
	function filter(criteria){
		$('.back4 tr').each(function(index,value){
			if ($(this).html().indexOf('����')<0 && $(this).html().indexOf('now')<0){
	...
	$('.back4 p:last').html('<a href="#" onclick="filter(\'���������\'); return false;">���������</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" onclick="filter(\'�����\'); return false;">�����</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" onclick="filter(\'���� ������\'); return false;">���� ������</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" onclick="filter(\'������������\'); return false;">������������</a><t/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" onclick="$(\'.back4 tr\').fadeIn(); return false;">���</a><t/>')
